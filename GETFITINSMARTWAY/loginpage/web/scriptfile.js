function createBill() {
    ...
    if (itemselected1 != "1") {
        ...
        cal[index] = document.getElementById("p1").value;
        index++;
    }
    ...
    if (itemselected2 != "1") {
        ...
        cal[index] = document.getElementById("p2").value;
        index++;
    }
    ...
    if (itemselected3 != "1") {
        ...
        cal[index] = document.getElementById("p3").value;
        index++;
    }
    ...
    if (itemselected4 != "1") {
        ...
        cal[index] = document.getElementById("p4").value;
        index++;
    }
    ...
    for (var i = 0; i < index; i++) {
        ...
        createtbl(cal[i]);
        var tot = parseInt(quantities[i]) * parseInt(cal[i]);
        document.write("<td>" + tot + "</td>");
        fTot += tot;
        document.write("</tr>");
    }
    document.write("<tr><td colspan=\"3\"><strong>TOTAL CALORIES</strong></td><td>" + fTot + "</td><tr>");
    strt(2);
}
...
function strt(n) {
    if (n == 1) {
        document.writeln("<h1 style=\"text-align:center;\">TOTAL CALORIES</h1>");
        document.writeln("<table width=\"90%\" border=\"1\">");
        document.writeln("<tr><th>ITEMS</th><th>QUANTITY</th><th>CALORIES</th><th></th></tr>");
    } else
